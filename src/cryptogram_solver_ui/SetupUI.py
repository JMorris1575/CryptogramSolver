...
from src.cryptogram_solver_ui import uiElements
...
class UserInterfaceSetup(object):
    ...
    def createAdminControls(self, menuBar, toolBar):
        ...
        self.createAction.setToolTip("Create and edit a new set of puzzles.")
        ...
        self.editAction = QAction(QIcon("../images/underConstruction.png"), "&Edit Collection...", self)
